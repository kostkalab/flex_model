...
class ResGatedConv(MessagePassing):
    ...
    def __init__(
        ...
        edge_dim: Optional[int] = None,  # Optional edge feature dimension
        ...
        **kwargs,
        ...
        self.gate_query = Linear(hidden_channels + edge_dim, hidden_channels)  # Target (reaction) queries
        self.gate_key = Linear(hidden_channels + edge_dim, hidden_channels)    # Source (gene) keys
        self.gate_value = Linear(hidden_channels + edge_dim, hidden_channels)  # Source (gene) values
        ...
        self.dn_project_tgt = Linear(in_channels[1], hidden_channels)  # Reaction projection
